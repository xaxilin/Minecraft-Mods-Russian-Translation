...
NEI.hide(<headcrumbs:betterSkull:*>);
NEI.hide(<headcrumbs:player:*>);
NEI.hide(<headcrumbs:empty:*>);
NEI.hide(<IronChest:BlockIronChest>);
NEI.hide(<IronChest:BlockIronChest:1>);
NEI.hide(<IronChest:BlockIronChest:2>);
NEI.hide(<IronChest:BlockIronChest:3>);
...
NEI.hide(<minecraft:red_flower:8>);
NEI.hide(<minecraft:red_flower:2>);
NEI.hide(<minecraft:red_flower:1>);
NEI.hide(<minecraft:tallgrass:2>);
NEI.hide(<minecraft:tallgrass:1>);
NEI.hide(<minecraft:dirt:2>);
NEI.hide(<headcrumbs:head:*>);
NEI.hide(<minecraft:skull:*>);
NEI.hide(<minecraft:cooked_fished:1>);
NEI.hide(<minecraft:golden_apple:1>);
NEI.hide(<minecraft:double_plant:5>);
NEI.hide(<minecraft:double_plant:4>);
NEI.hide(<minecraft:double_plant:3>);
NEI.hide(<minecraft:double_plant:2>);
NEI.hide(<minecraft:double_plant:1>);
NEI.hide(<minecraft:red_flower:3>);
NEI.hide(<minecraft:red_flower:4>);
NEI.hide(<minecraft:red_flower:5>);
NEI.hide(<minecraft:red_flower:6>);
NEI.hide(<minecraft:red_flower:7>);
NEI.hide(<HardcoreQuesting:bags:4>);
NEI.hide(<HardcoreQuesting:bags:3>);
NEI.hide(<HardcoreQuesting:bags:2>);
NEI.hide(<HardcoreQuesting:bags:1>);
NEI.hide(<HardcoreQuesting:bags>);
NEI.hide(<HardcoreQuesting:hearts:4>);
NEI.hide(<HardcoreQuesting:hearts:3>);
NEI.hide(<HardcoreQuesting:hearts:2>);
NEI.hide(<HardcoreQuesting:hearts:1>);
NEI.hide(<HardcoreQuesting:hearts>);
NEI.hide(<HardcoreQuesting:quest_portal>);
NEI.hide(<HardcoreQuesting:quest_tracker>);
NEI.hide(<HardcoreQuesting:item_barrel>);